...
//
extern NSData* MoccaEncodeData(NSData *data);
...
//
extern NSData* MoccaDecodeData(NSData *data);
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
extern NSData* MoccaEncodeBytes(const void *bytes, NSUInteger length);
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
extern NSData* MoccaDecodeBytes(const void *bytes, NSUInteger length);
...
//
extern NSString* MoccaStringByEncodingData(NSData *data);
...
///   A new autoreleased NSString with the encoded payload.  nil for any error.
//
extern NSString* MoccaStringByEncodingBytes(const void *bytes, NSUInteger length);
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
extern NSData* MoccaDecodeString(NSString *string);
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
extern NSData* MoccaWebSafeEncodeData(NSData *data, BOOL padded);
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
extern NSData* MoccaWebSafeDecodeData(NSData *data);
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
extern NSData* MoccaWebSafeEncodeBytes(const void *bytes, NSUInteger length, BOOL padded);
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
extern NSData* MoccaWebSafeDecodeBytes(const void *bytes, NSUInteger length);
...
///   A new autoreleased NSString with the encoded payload.  nil for any error.
//
extern NSString* MoccaStringByWebSafeEncodingData(NSData *data, BOOL padded);
...
///   A new autoreleased NSString with the encoded payload.  nil for any error.
//
extern NSString* MoccaStringByWebSafeEncodingBytes(const void *bytes, NSUInteger length, BOOL padded);
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
extern NSData* MoccaWebSafeDecodeString(NSString *string);
